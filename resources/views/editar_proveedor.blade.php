...
<head>
    ...
    <title>Editor de proveedor</title>
</head>
<body class="fondo">
    @include('header2') <br>
    @include('mensaje')
    ...
    <div class="main">
        <div class="container">
            <h2>Editor de proveedor</h2>
            <div class="contenido">
                <div class="form1">
                    <form action="{{route('proveedor.update', $datos_proveedor->pk_proveedor)}}" method="post" class="form2" id="form2" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="form-row">
                            ...
                            <div class="form-grupo">
                                ...
                                <div class="form-campo">
                                    ...
                                    <input style="background-color: white" type="text" name="razon_social" id="razon_social" value="{{$datos_proveedor->razon_social}}" class="input-no-persona" />
                                ...
                                <div class="form-campo">
                                    ...
                                    <input style="background-color: rgb(205, 205, 205)" type="text" name="nombres" id="nombres" value="{{$datos_proveedor->datos_comunes->nombres}}" class="input-persona" placeholder="No disponible" disabled />
                                </div>
                                <div class="form-campo">
                                    <label for="a_paterno" class="required">Apellido paterno</label>
                                    <input style="background-color: rgb(205, 205, 205)" type="text" name="a_paterno" id="a_paterno" value="{{$datos_proveedor->datos_comunes->a_paterno}}" class="input-persona" placeholder="No disponible" disabled />
                                </div>
                                <div class="form-campo">
                                    <label for="a_materno">Apellido materno</label>
                                    <input style="background-color: rgb(205, 205, 205)" type="text" name="a_materno" id="a_materno" value="{{$datos_proveedor->datos_comunes->a_materno}}" class="input-persona" placeholder="No disponible" disabled />
                                </div>
                                <div class="form-campo">
                                    <label for="correo">Correo</label>
                                    <input type="text" name="correo" id="correo" value="{{$datos_proveedor->datos_comunes->correo}}" />
                                </div>
                                <div class="form-campo">
                                    <label for="telefono">Teléfono</label>
                                    <input type="text" name="telefono" id="telefono" value="{{$datos_proveedor->datos_comunes->telefono}}" />
                                </div>
                            </div>
                            <div class="form-grupo">
                                <h5>&nbsp</h5>
                                ...
                                <select class="form-select" name="fk_pais">
                                    ...
                                    @foreach ($datos_pais as $dp)
                                        <option @if ($dp->fk_pais == $datos_proveedor->pk_pais) selected @endif value="{{$dp->pk_pais}}">{{$dp->nom_pais}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_estado">
                                    ...
                                    @foreach ($datos_estado as $dp)
                                        <option @if ($dp->fk_estado == $datos_proveedor->pk_estado) selected @endif value="{{$dp->pk_estado}}">{{$dp->nom_estado}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_municipio">
                                    ...
                                    @foreach ($datos_municipio as $dp)
                                        <option @if ($dp->fk_municipio == $datos_proveedor->pk_municipio) selected @endif value="{{$dp->pk_municipio}}">{{$dp->nom_municipio}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_ubicacion">
                                    ...
                                    @foreach ($datos_ubicacion as $dp)
                                        <option @if ($dp->fk_ubicacion == $datos_proveedor->pk_ubicacion) selected @endif value="{{$dp->pk_ubicacion}}">{{$dp->nom_ubicacion}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_nacionalidad">
                                    ...
                                    @foreach ($datos_nacionalidad as $dp)
                                        <option @if ($dp->fk_nacionalidad == $datos_proveedor->pk_nacionalidad) selected @endif value="{{$dp->pk_nacionalidad}}">{{$dp->nom_nacionalidad}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_sucursal" required>
                                    ...
                                    @foreach ($datos_sucursal as $dp)
                                        <option @if ($dp->fk_sucursal == $datos_proveedor->pk_sucursal) selected @endif value="{{$dp->pk_sucursal}}">{{$dp->nom_sucursal}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-grupo">
                                ...
                                <div class="form-campo">
                                    ...
                                    <input type="text" name="calle" id="calle" value="{{$datos_proveedor->datos_comunes->direccion->calle}}" />
                                </div>
                                <div class="form-campo">
                                    <label for="colonia">Colonia</label>
                                    <input type="text" name="colonia" id="colonia" value="{{$datos_proveedor->datos_comunes->direccion->colonia}}" />
                                </div>
                                <div class="form-campo">
                                    <label for="numero">Número</label>
                                    <input type="number" name="numero" id="numero" value="{{$datos_proveedor->datos_comunes->direccion->numero}}" />
                                </div>
                                <div class="form-campo">
                                    <label for="cp" class="required">Código postal</label>
                                    <input type="text" name="cp" id="cp" maxlength="5" value="{{$datos_proveedor->datos_comunes->direccion->cp}}" required />
                                </div>
                                <div class="form-campo">
                                    <label for="curp">CURP</label>
                                    <input type="text" name="curp" id="curp" value="{{$datos_proveedor->datos_comunes->curp}}" />
                                </div>
                                <div class="form-campo">
                                    <label for="rfc" class="required">RFC</label>
                                    <input type="text" name="rfc" id="rfc" value="{{$datos_proveedor->rfc}}" required />
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-grupo">
                                ...
                                <div class="form-campo">
                                    ...
                                    <input type="text" name="cuenta_contable_mn" id="cuenta_contable_mn" value="{{$datos_proveedor->cuenta_contable_mn}}" />
                                </div>
                                <div class="form-campo">
                                    <label for="cuenta_contable_dls">Cuenta contable Dls</label>
                                    <input type="text" name="cuenta_contable_dls" id="cuenta_contable_dls" value="{{$datos_proveedor->cuenta_contable_dls}}" />
                                </div>
                            </div>
                            <div class="form-grupo">
                                <h5>&nbsp</h5>
                                <div class="form-campo">
                                    ...
                                    <input type="text" name="cuenta_complementaria" id="cuenta_complementaria" value="{{$datos_proveedor->cuenta_complementaria}}" />
                                </div>
                                <div class="form-campo">
                                    <label for="cuenta_afectable">Cuenta afectable</label>
                                    <input type="text" name="cuenta_afectable" id="cuenta_afectable" value="{{$datos_proveedor->cuenta_afectable}}" />
                                </div>
                            </div>
                        </div>
                        <hr style="height: 2px">
                        <div class="form-row">
                            <div class="form-grupo">
                                ...
                                <div class="form-campo">
                                    ...
                                    <input type="number" name="dias_credito" id="dias_credito" value="{{$datos_proveedor->credito->dias_credito}}" required />
                                </div>
                                <div class="form-campo">
                                    <label for="tiempo_surtido" class="required">Tiempo de surtido</label>
                                    <input type="number" name="tiempo_surtido" id="tiempo_surtido" value="{{$datos_proveedor->credito->tiempo_surtido}}" required />
                                </div>
                                ...
                                <select class="form-select" name="fk_tipo_proveedor" required>
                                    ...
                                    @foreach ($datos_tipo_proveedor as $dp)
                                        <option @if ($dp->fk_tipo_proveedor == $datos_proveedor->pk_tipo_proveedor) selected @endif value="{{$dp->pk_tipo_proveedor}}">{{$dp->nom_tipo_proveedor}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_tipo_operacion" required>
                                    ...
                                    @foreach ($datos_tipo_operacion as $dp)
                                        <option @if ($dp->fk_tipo_operacion == $datos_proveedor->pk_tipo_operacion) selected @endif value="{{$dp->pk_tipo_operacion}}">{{$dp->nom_tipo_operacion}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-grupo">
                                ...
                                <div class="check-grupo label-flex">
                                    <div class="label-flex">
                                        <input class="form-check-input me-3" type="checkbox" name="extranjero" @if ($datos_proveedor->extranjero=='si') checked @endif value="si" >
                                        <label for="extranjero">Extranjero</label>
                                    </div>
                                    <br><br><br>
                                    <div class="label-flex">
                                        <input class="form-check-input me-3" type="checkbox" name="multiafectable" @if ($datos_proveedor->multiafectable=='si') checked @endif value="si" >
                                        <label for="multiafectable">Multiafectable</label>
                                    </div>
                                    <br><br><br>
                                    <div class="label-flex">
                                        <input class="form-check-input me-3" type="checkbox" name="riego" @if ($datos_proveedor->riego=='si') checked @endif value="si" >
                        ...
                        <div class="form-row">
                            <div class="form-grupo">
                                <div class="form-campo">
                                    <label for="fecha_ult_mod">Fecha de modificación: </label>
