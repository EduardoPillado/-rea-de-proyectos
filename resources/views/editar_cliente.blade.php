...
<body class="fondo">
    ...
    <div class="main">
        <div class="container">
            ...
            <div class="contenido">
                <div class="form1">
                    <form action="{{route('cliente.update', $datos_cliente->pk_cliente)}}" method="post" class="form2" id="form2" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="form-row">
                            ...
                            <div class="form-grupo">
                                ...
                                <div class="form-campo">
                                    ...
                                    <input type="text" name="razon_social" id="razon_social" value="{{$datos_cliente->razon_social}}" class="input-no-persona" />
                                ...
                                <div class="form-campo">
                                    ...
                                    <input type="text" name="nombres" id="nombres" value="{{$datos_cliente->datos_comunes->nombres}}" class="input-persona" placeholder="No disponible" disabled />
                                </div>
                                <div class="form-campo" class="required">
                                    <label for="a_paterno">Apellido paterno</label>
                                    <input type="text" name="a_paterno" id="a_paterno" value="{{$datos_cliente->datos_comunes->a_paterno}}" class="input-persona" placeholder="No disponible" disabled />
                                </div>
                                <div class="form-campo">
                                    <label for="a_materno">Apellido materno</label>
                                    <input type="text" name="a_materno" id="a_materno" value="{{$datos_cliente->datos_comunes->a_materno}}" class="input-persona" placeholder="No disponible" disabled />
                                </div>
                                <div class="form-campo">
                                    <label for="correo" class="required">Correo</label>
                                    <input type="text" name="correo" id="correo" value="{{$datos_cliente->datos_comunes->correo}}" required />
                                </div>
                                <div class="form-campo">
                                    <label for="telefono" class="required">Teléfono</label>
                                    <input type="text" name="telefono" id="telefono" value="{{$datos_cliente->datos_comunes->telefono}}" required />
                                </div>
                                <div class="form-campo">
                                    <label for="rfc" class="required">RFC</label>
                                    <input type="text" name="rfc" id="rfc" value="{{$datos_cliente->rfc}}" required />
                                </div>
                            </div>
                            <div class="form-grupo">
                                <h5>&nbsp</h5>
                                ...
                                <select class="form-select" name="fk_pais" required>
                                    ...
                                    @foreach ($datos_pais as $dp)
                                        <option @if ($dp->fk_pais == $datos_cliente->pk_pais) selected @endif value="{{$dp->pk_pais}}">{{$dp->nom_pais}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_estado" required>
                                    ...
                                    @foreach ($datos_estado as $dp)
                                        <option @if ($dp->fk_estado == $datos_cliente->pk_estado) selected @endif value="{{$dp->pk_estado}}">{{$dp->nom_estado}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_municipio" required>
                                    ...
                                    @foreach ($datos_municipio as $dp)
                                        <option @if ($dp->fk_municipio == $datos_cliente->pk_municipio) selected @endif value="{{$dp->pk_municipio}}">{{$dp->nom_municipio}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_ubicacion" required>
                                    ...
                                    @foreach ($datos_ubicacion as $dp)
                                        <option @if ($dp->fk_ubicacion == $datos_cliente->pk_ubicacion) selected @endif value="{{$dp->pk_ubicacion}}">{{$dp->nom_ubicacion}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_nacionalidad" required>
                                    ...
                                    @foreach ($datos_nacionalidad as $dp)
                                        <option @if ($dp->fk_nacionalidad == $datos_cliente->pk_nacionalidad) selected @endif value="{{$dp->pk_nacionalidad}}">{{$dp->nom_nacionalidad}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_regimen_fiscal" required>
                                    ...
                                    @foreach ($datos_reg_fisc as $dp)
                                        <option @if ($dp->fk_regimen_fiscal == $datos_cliente->pk_regimen_fiscal) selected @endif value="{{$dp->pk_regimen_fiscal}}">{{$dp->regimen_fiscal}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_uso_cfdi" required>
                                    ...
                                    @foreach ($datos_uso_cfdi as $dp)
                                        <option @if ($dp->fk_uso_cfdi == $datos_cliente->pk_uso_cfdi) selected @endif value="{{$dp->pk_uso_cfdi}}">{{$dp->uso_cfdi}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-grupo">
                                ...
                                <div class="form-campo">
                                    ...
                                    <input type="text" name="calle" id="calle" value="{{$datos_cliente->datos_comunes->direccion->calle}}" required />
                                </div>
                                <div class="form-campo">
                                    <label for="colonia" class="required">Colonia</label>
                                    <input type="text" name="colonia" id="colonia" value="{{$datos_cliente->datos_comunes->direccion->colonia}}" required />
                                </div>
                                <div class="form-campo">
                                    <label for="numero" class="required">Número</label>
                                    <input type="number" name="numero" id="numero" value="{{$datos_cliente->datos_comunes->direccion->numero}}" required />
                                </div>
                                <div class="form-campo">
                                    <label for="cp" class="required">Código postal</label>
                                    <input type="text" name="cp" id="cp" maxlength="5" value="{{$datos_cliente->datos_comunes->direccion->cp}}" required />
                                </div>
                                <div class="form-campo">
                                    <label for="curp" class="required">CURP</label>
                                    <input type="text" name="curp" id="curp" value="{{$datos_cliente->datos_comunes->curp}}" required />
                                </div>
                                ...
                                <select class="form-select" name="fk_sucursal" required>
                                    ...
                                    @foreach ($datos_sucursal as $dp)
                                        <option @if ($dp->fk_sucursal == $datos_cliente->pk_sucursal) selected @endif value="{{$dp->pk_sucursal}}">{{$dp->nom_sucursal}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-grupo">
                                ...
                                <div class="form-campo">
                                    ...
                                    <input type="text" name="cuenta_contable_mn" id="cuenta_contable_mn" value="{{$datos_cliente->cuenta_contable_mn}}" />
                                </div>
                                <div class="form-campo">
                                    <label for="cuenta_anticipo">Cuenta anticipo</label>
                                    <input type="text" name="cuenta_anticipo" id="cuenta_anticipo" value="{{$datos_cliente->cuenta_anticipo}}" />
                                </div>
                            </div>
                            <div class="form-grupo">
                                <h5>&nbsp</h5> <br><br><br>
                                <div class="check-grupo label-flex">
                                    <div class="label-flex">
                                        <input class="form-check-input me-3" type="checkbox" name="extranjero" @if ($datos_cliente->extranjero=='si') checked @endif value="si" >
                                        Extranjero
                                    </div>
                                    <br><br>
                                    <div class="label-flex">
                                        <input class="form-check-input me-3" type="checkbox" name="multisucursal" @if ($datos_cliente->multisucursal=='si') checked @endif value="si" >
                                        Multisucursal
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-grupo">
                                ...
                                <select class="form-select" name="fk_agente" required>
                                    ...
                                    @foreach ($datos_agente as $dp)
                                        <option @if ($dp->fk_agente == $datos_cliente->pk_agente) selected @endif value="{{$dp->pk_agente}}">{{$dp->nom_agente}}</option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="fk_grupo_cliente" required>
                                    ...
                                    @foreach ($datos_grp_cli as $dp)
                                        <option @if ($dp->fk_grupo_cliente == $datos_cliente->pk_grupo_cliente) selected @endif value="{{$dp->pk_grupo_cliente}}">{{$dp->nom_grupo}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-grupo">
                                ...
                                <div class="check-grupo label-flex">
                                    <div class="label-flex">
                                        <input class="form-check-input me-3" type="checkbox" name="cliente_agricultor" @if ($datos_cliente->cliente_agricultor=='si') checked @endif value="si" >
                                        Cliente Agricultor
                                    </div>
                                    <br><br>
                                    <div class="label-flex">
                                        <input class="form-check-input me-3" type="checkbox" name="cliente_iva_extra" @if ($datos_cliente->cliente_iva_extra=='si') checked @endif value="si" >
                                        Cliente IVA Extra
                                    </div>
                                </div>
                            </div>
