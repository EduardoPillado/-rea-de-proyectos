    ...
    <div class="main">
        <div class="container">
            ...
            {{-- Ordenar y filtrar --}}
                    <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
                        ...
                        <div class="offcanvas-body">
                            <div class="filtro1">
                                <a class="filtro2 {{Request::route()->getName()=='producto.mostrar'?'filtro-activo':''}}" id="filtro2" href="{{route('producto.mostrar')}}">
                                    Todos
                                </a>
                                <br>
                            </div>
                            <div class="filtro1">
                                <a class="filtro2 {{Request::route()->getName()=='producto.activos'?'filtro-activo':''}}" id="filtro2" href="{{route('producto.activos')}}">
                                    Activos
                                </a>
                                <br>
                            </div>
                            <div class="filtro1">
                                <a class="filtro2 {{Request::route()->getName()=='producto.bloqueados'?'filtro-activo':''}}" id="filtro2" href="{{route('producto.bloqueados')}}">
                                    Bloqueados
                                </a>
                                <br>
                            </div>
                            ...
                            <hr>
                            <div class="filtro1">
                                <form action="{{route('producto.filtrarPorRangoFechas')}}" method="GET">
            ...
            <div class="table-back">
                <table class="table table-bordered border-list" id="tabla-productos">
                    <thead>
                        <tr>
                            <th>Código</th>
                            <th>Producto</th>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                @if ($dato->imagen_producto)
                                    <a href="{{route('producto.descargar', $dato->pk_producto)}}">
                                        <i class="bi bi-download" title="Descargar imagen"></i>
                                    </a>
                                @else
                            ...
                            <td>{{$dato->proveedor->razon_social.' '.$dato->proveedor->datos_comunes->nombres.' '.$dato->proveedor->datos_comunes->a_paterno.' '.$dato->proveedor->datos_comunes->a_materno}}</td>
                            <td>{{$dato->estatus}}</td>
                            <td>
                                <div class="opciones">
                                    <div>
                                        <a href="{{route('producto.actualizado', $dato->pk_producto)}}">
                                            <i class="bi bi-pencil-square" title="Editar datos"></i>
                                        </a>
                                    </div>
                                    <div>
                                        @if ($dato->estatus == 'Activo')
                                            <a href="{{route('producto.bloquear', $dato->pk_producto)}}">
                                                <i class="bi bi-lock" title="Bloquear"></i>
                                            </a>
                                        @else
                                            <a href="{{route('producto.activar', $dato->pk_producto)}}">
                                                <i class="bi bi-unlock" title="Activar"></i>
                                            </a>
                                        @endif
                                    </div>
                                    <div>
                                        <a href="{{route('producto.allInfo', $dato->pk_producto)}}">
