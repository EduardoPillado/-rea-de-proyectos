...
<div class="main">
    <div class="container">
        <h2>Editor de proyecto</h2>
        <div class="contenido">
            <div class="form1">
                <form action="{{route('proyecto_general.update', $datos_proyecto_general->pk_proyecto_general)}}" method="post" class="form2" id="form2" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-row">
                        <div class="form-grupo">
                            ...
                            <select class="form-select" name="fk_cliente" required>
                                ...
                                @foreach ($datos_cliente as $dp)
                                    @if ($dp->estatus === 'Activo')
                                        <option @if ($dp->fk_cliente == $datos_proyecto_general->pk_cliente) selected @endif value="{{$dp->pk_cliente}}">
                            ...
                            <div class="form-campo">
                                ...
                                <input type="text" name="nom_proyecto_general" id="nom_proyecto_general" value="{{$datos_proyecto_general->nom_proyecto_general}}" required>
                            </div>
                        </div>
                        <div class="form-grupo">
                            ...
                            <select class="form-select" name="fk_sucursal" required>
                                ...
                                @foreach ($datos_sucursal as $dp)
                                    <option @if ($dp->fk_sucursal == $datos_proyecto_general->pk_sucurfk_sucursal) selected @endif value="{{$dp->pk_sucursal}}">{{$dp->nom_sucursal}}</option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-select" name="fk_cultivo" required>
                                ...
                                @foreach ($datos_cultivo as $dp)
                                    <option @if ($dp->fk_cultivo == $datos_proyecto_general->pk_cultivo) selected @endif value="{{$dp->pk_cultivo}}">{{$dp->nom_cultivo}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-grupo">
                            ...
                            <select class="form-select" name="fk_sistema_riego" required>
                                ...
                                @foreach ($datos_sistema_riego as $dp)
                                    <option @if ($dp->fk_sistema_riego == $datos_proyecto_general->pk_sistema_riego) selected @endif value="{{$dp->pk_sistema_riego}}">{{$dp->nom_sistema}}</option>
                                @endforeach
                            </select>

                            <div class="form-campo">
                                <label for="superficie" class="required">Superficie (Hectáreas)</label>
                                <input type="decimal" name="superficie" id="superficie" value="{{$datos_proyecto_general->superficie}}" required />
                            </div>
                        </div>
                    </div>
                    <hr style="height: 2px">
                    <div class="form-row">
                        <div class="form-grupo">
                            <div class="form-campo">
                                ...
                                <input type="number" name="vigencia_dias" id="vigencia_dias" value="{{$datos_proyecto_general->vigencia_dias}}" required>
                            </div>
                        </div>
                        <div class="form-grupo">
                            <div class="form-campo">
                                <label for="predio" class="required">Predio</label>
                                <input type="text" name="predio" id="predio" value="{{$datos_proyecto_general->predio}}" required>
                            </div>
                        </div>
                        <div class="form-grupo">
                            <div class="label-flex">
                            ...
                            <select class="form-select" name="fk_etapa" required>
                                ...
                                @foreach ($datos_etapa as $dp)
                                    <option @if ($dp->fk_etapa == $datos_proyecto_general->pk_etapa) selected @endif value="{{$dp->pk_etapa}}">{{$dp->nom_etapa}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-grupo">
                            ...
                            <select class="form-select" name="fk_categoria_proyecto">
                                ...
                                @foreach ($datos_categoria_proyecto as $dp)
                                    <option @if ($dp->fk_categoria_proyecto == $datos_proyecto_general->pk_categoria_proyecto) selected @endif value="{{$dp->pk_categoria_proyecto}}">{{$dp->nom_cat_proy}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-grupo">
                            ...
                            <select class="form-select" name="fk_cotizacion">
                                ...
                                @foreach ($datos_cotizacion as $dp)
                                    @if ($dp->estatus === 'Activo')
                                        <option @if ($dp->fk_cotizacion == $datos_proyecto_general->pk_cotizacion) selected @endif value="{{$dp->pk_cotizacion}}">{{$dp->nom_archivo}}</option>
                                    @endif
                                @endforeach
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-grupo">
                            <div class="form-campo">
                                ...
                                <input type="text" name="nom_ubicacion_proyecto" id="nom_ubicacion_proyecto" value="{{$datos_proyecto_general->nom_ubicacion_proyecto}}" required>
                            </div>
                        </div>
                        <div class="form-grupo">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="fk_almacen_existencias[]"
                                                    ...
                                                    @if ($datos_proyecto_general->proyecto_producto->contains('fk_almacen_existencias', $dp->pk_almacen_existencias)) checked @endif
                                                    >
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @if ($datos_proyecto_general->proyecto_producto->where('fk_almacen_existencias', $dp->pk_almacen_existencias)->first())
                                                    value="{{ $datos_proyecto_general->proyecto_producto->where('fk_almacen_existencias', $dp->pk_almacen_existencias)->first()->cant_unidades }}"
                                                @endif
                                                >
                                            </td>
                                            <td>
                                                ...
                                                @if ($datos_proyecto_general->proyecto_producto->where('fk_almacen_existencias', $dp->pk_almacen_existencias)->first())
                                                    value="{{ $datos_proyecto_general->proyecto_producto->where('fk_almacen_existencias', $dp->pk_almacen_existencias)->first()->descuento }}"
                                                @endif
                                                >
                                            </td>
                                        </tr>
                        ...
                        <div class="form-grupo">
                            ...
                            <select class="form-select" name="fk_empleado" required>
                                ...
                                @foreach ($datos_empleado as $dp)
                                    @if ($dp->estatus === 'Activo')
                                        <option @if ($dp->fk_empleado == $datos_proyecto_general->pk_empleado) selected @endif value="{{$dp->pk_empleado}}">
