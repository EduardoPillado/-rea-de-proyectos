...
<body class="fondo">
    ...
    <div class="main">
        <div class="container">
            ...
            <div class="contenido">
                <div class="form1">
                    <form action="{{route('empleado.insertar')}}" method="post" class="form2" id="form2" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-grupo">
                                ...
                                <select class="form-select" name="fk_puesto_empleado" required>
                                    ...
                                    @foreach ($datos_puesto_empleado as $dp)
                                        <option value="{{$dp->pk_puesto_empleado}}">{{$dp->nom_puesto}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
