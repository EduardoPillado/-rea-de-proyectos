...
<div class="main">
    <div class="container">
        ...
        <div class="contenido">
            <div class="form1">
                <form action="{{route('producto.insertar')}}" method="post" class="form2" id="form2" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="form-grupo">
                            ...
                            <div class="form-campo">
                                ...
                                <textarea name="descrip" id="descrip" rows="6"></textarea>
                            </div>
                        </div>
                        <div class="form-grupo">
                            <h5>&nbsp</h5>
                            ...
                            <select class="form-select" name="fk_area_sucursal" required>
                                ...
                                @foreach ($datos_area_sucursal as $dp)
                                    <option value="{{$dp->pk_area_sucursal}}">{{$dp->nom_area}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-grupo">
                            ...
                            <div class="label-flex">
                                <label class="required">División</label>
                            ...
                            <select class="form-select" name="fk_division" required>
                                ...
                                @foreach ($datos_division as $dp)
                                    <option value="{{$dp->pk_division}}">{{$dp->nom_division}}</option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-select" name="fk_subgrupo_producto" required>
                                ...
                                @foreach ($datos_subgrupo_producto as $dp)
                                    <option value="{{$dp->pk_subgrupo_producto}}">{{$dp->nom_subgrupo}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-grupo">
                            ...
                            <select class="form-select" name="fk_unidad_medida" required>
                                ...
                                @foreach ($datos_unidad_medida as $dp)
                                    <option value="{{$dp->pk_unidad_medida}}">{{$dp->tipo_unidad}}</option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-select" name="fk_clave_prod_serv_sat" required>
                                ...
                                @foreach ($datos_clave_prod_serv_sat as $dp)
                                    <option value="{{$dp->pk_clave_prod_serv_sat}}">{{$dp->clave_serv}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-row">
                        <div class="form-grupo">
                            ...
                            <div class="form-campo">
                                ...
                                <input type="decimal" name="cantidad_unitaria" id="cantidad_unitaria" required />
                            </div>
                            <div class="form-campo">
                                <label for="cantidad_proyecto">Precio proyecto</label>
                                <input type="decimal" name="cantidad_proyecto" id="cantidad_proyecto" />
                            </div>
                            <div class="form-campo">
                                <label for="ultima_cantidad">Ultimo costo</label>
                                <input type="decimal" name="ultima_cantidad" id="ultima_cantidad" />
                            </div>
                        </div>
                        <div class="form-grupo">
                            <h5>&nbsp</h5>
                            ...
                            <div class="form-campo">
                                ...
                                <input type="decimal" name="cantidad_especial" id="cantidad_especial" />
                            </div>
                            <div class="form-campo">
                                <label for="margen_utilidad_porcentaje">Margen utilidad %</label>
                                <input type="number" name="margen_utilidad_porcentaje" id="margen_utilidad_porcentaje" placeholder="Sin simbolo %" />
                            </div>
                        </div>
                        <div class="form-grupo">
                            <h5>&nbsp</h5>
                            ...
                            <div class="form-campo">
                                ...
                                <input type="decimal" name="cantidad_promedio" id="cantidad_promedio" />
                            </div>
                    ...
                    <div class="form-row">
                        <div class="form-grupo">
                            <div class="form-campo">
                                <label for="fecha_ultima_mod">Fecha de registro: </label>
