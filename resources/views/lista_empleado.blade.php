    ...
    <div class="main">
        <div class="container">
            ...
            {{-- Ordenar y filtrar --}}
                    <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
                        ...
                        <div class="offcanvas-body">
                            <div class="filtro1">
                                <a class="filtro2 {{Request::route()->getName()=='empleado.mostrar'?'filtro-activo':''}}" id="filtro2" href="{{route('empleado.mostrar')}}">
                                    Todos
                                </a>
                                <br>
                            </div>
                            <div class="filtro1">
                                <a class="filtro2 {{Request::route()->getName()=='empleado.activos'?'filtro-activo':''}}" id="filtro2" href="{{route('empleado.activos')}}">
                                    Activos
                                </a>
                                <br>
                            </div>
                            <div class="filtro1">
                                <a class="filtro2 {{Request::route()->getName()=='empleado.bloqueados'?'filtro-activo':''}}" id="filtro2" href="{{route('empleado.bloqueados')}}">
                                    Bloqueados
                                </a>
                                <br>
                            </div>
                            ...
                            <hr>
                            <div class="filtro1">
                                <form action="{{route('empleado.filtrarPorRangoFechas')}}" method="GET">
            ...
            <div class="table-back">
                <table class="table table-bordered border-list" id="tabla-empleados">
                    <thead>
                        <tr>
                            <th>Código</th>
                            <th>Nombre</th>
                    ...
                    @foreach ($datos_empleado as $dato)
                        <tr>
                            ...
                            <td align="center">
                                @if ($dato->curriculum)
                                    <a href="{{route('empleado.descargar', $dato->pk_empleado)}}">
                                        <i class="bi bi-download" title="Descargar currículum"></i>
                                    </a>
                                @else
                                    <h6 style="color: rgb(99, 99, 99)">No se ha cargado ningún currículum</h6>
                                @endif
                            </td>
                            <td>{{$dato->estatus}}</td>
                            <td>
                                <div class="opciones">
                                    <div>
                                        <a href="{{route('empleado.actualizado', $dato->pk_empleado)}}">
                                            <i class="bi bi-pencil-square" title="Editar datos"></i>
                                        </a>
                                    </div>
                                    <div>
                                        @if ($dato->estatus == 'Activo')
                                            <a href="{{route('empleado.bloquear', $dato->pk_empleado)}}">
                                                <i class="bi bi-lock" title="Bloquear"></i>
                                            </a>
                                        @else
                                            <a href="{{route('empleado.activar', $dato->pk_empleado)}}">
                                                <i class="bi bi-unlock" title="Activar"></i>
                                            </a>
                                        @endif
                                    </div>
                                    <div>
                                        <a href="{{route('empleado.allInfo', $dato->pk_empleado)}}">
